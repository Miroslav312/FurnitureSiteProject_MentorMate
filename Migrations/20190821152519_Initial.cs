        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultPasswordChanged = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(maxLength: 370, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddQuantityViewModel", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AddQuantityViewModel_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddQuantityViewModel_ItemId",
                table: "AddQuantityViewModel",
                column: "ItemId");
